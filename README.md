...
| Strip slicer feature/metadata comments | `;TYPE:`, `;WIDTH:`, `;HEIGHT:`, `;Z:`, wipe/flush/object markers, Orca's HEADER/THUMBNAIL/EXECUTABLE block delimiters, `; generated by …`, `; total layer number:`, `; filament_*:`, `; * extrusion width = *`, Klipper `;_SET_FAN_SPEED` hints, bare `;` separators. Preserves layer markers (`LAYER_CHANGE`, `LAYER_COUNT`) which BTT firmware does read. |
